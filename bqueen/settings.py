"""
Django settings for bqueen project.
...
SECRET_KEY = '8uob%r%&h7rvpoakp*8)$gti$i-r^jm8y$p9*b-ukol@cn53zo'
...
WSGI_APPLICATION = 'bqueen.wsgi.application'
